...
export const MainHeader = () => {
  ...
  return (
    <header className="accent-black text-blue-500 font-semibold shadow-2xl flex justify-center">
      <div className="w-full top-0 left-0 sm:px-6 lg:px-8 flex justify-between items-center fixed z-10 bg-white shadow-2xl rounded-br-full rounded-full">
        {/* Logo */}
        <div className="hover:cursor-pointer xs:pl-2">
        ...
        <div className="relative sm:hidden xs:max-h-10">
          ...
          {/* <img
            src={logo2}
            alt=""
            className="animate-drive xs:h-10"
            style={{ top: "50%" }}
          /> */}
        </div>
        ...
        <nav className="hidden sm:flex">
          <ul className="flex justify-center gap-10 hover:cursor-pointer">
            <li className="hover:text-fuchsia-800 transition-transform duration-500 ease-in-out scale-100 hover:scale-125">
              <Link to="/">HOME</Link>
            </li>
            <li className="hover:text-fuchsia-800 transition-transform duration-500 ease-in-out scale-100 hover:scale-125">
