      ...
      <div className="w-full top-0 left-0 sm:px-6 lg:px-8 flex justify-between items-center fixed z-10 bg-white shadow-2xl rounded-br-3xl rounded-bl-3xl">
        ...
        <nav className="hidden sm:flex">
          <ul className="flex justify-center gap-10 hover:cursor-pointer">
            <li className="active:hover:text-fuchsia-800 transition-transform duration-500 ease-in-out scale-100 hover:scale-125">
              <Link to="/">HOME</Link>
            </li>
            <li className="active:hover:text-fuchsia-800 transition-transform duration-500 ease-in-out scale-100 hover:scale-125">
      ...
      >
        <div className="p-6 w-64">
          <ul className="flex flex-col gap-4 text-center">
            <li className="active:hover:text-fuchsia-800 transition-transform duration-600 ease-in-out scale-100 hover:scale-125">
